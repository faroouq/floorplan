%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Description:   BUILDRELATIONS Given a set of rectangle areas, tries to 
%               come up with a relative arrangement of those rectangles, 
%               such that the area is most evenly distributed accross the 
%               total area. Returns the vertical and horizontal positioning
%               graphs as matrices.
%
%Dependencies:  splitAreas
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
